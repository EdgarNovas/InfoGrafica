...
void main() {
	...
	if (glewInit() == GLEW_OK) {
		...
		//Definimos canal de texturas activo
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, textureInfo); //El primer 0 es que nivel de mipmap es, el segundo 0 es el borde

		//Genera mipmap
		glGenerateMipmap(GL_TEXTURE_2D);

		//Liberar textura de ram
		...
		//Asignar valor de textura a usar
